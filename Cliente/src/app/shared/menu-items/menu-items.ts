...
const MENUITEMS = [
    {state: 'starter', name: 'Principal', type: 'link', icon: 'dashboard' },
    {state: 'tipo_usuarios', name: 'Tipo Usuario', type: 'link', icon: 'supervised_user_circle' },
    {state: 'usuarios', name: 'Usuario', type: 'link', icon: 'supervisor_account' },
    {state: 'categorias', name: 'Categorias', type: 'link', icon: 'view_list' },
    {state: 'productos', name: 'Productos', type: 'link', icon: 'pages' },
